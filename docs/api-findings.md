...
```
VISITSEOUL_CATEGORIES=Cv7s8m5,Ca0o2d4,Ca1z6p7,Co6c2n2
```

= 축제/공연/행사(1,188) + 문화관광(733) + 역사(88) + 자연(68) = **2,077건**

음식(1,267)·쇼핑(298)·숙박(17)은 제외했습니다. "이번 주 무슨 행사가 있나"와
"언제 가도 좋은 곳"에 식당·백화점·호텔은 맞지 않습니다.
체험 프로그램(122)은 경계선이라 일단 뺐습니다 — 필요하면 `Cc9i5o2`를 추가하면 됩니다.
...
| hydrate 초회 호출 수 | **약 2,077회** (제안 카테고리 기준). 120ms 간격이면 **약 4분** |
...
| 4 | 카테고리 수집 범위 | ⚠️ **제안까지. 확정 필요** (위 "수집 대상 카테고리") |
